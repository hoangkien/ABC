								...
								render json:{ 
												status:0,message: "Success",details:{
													group: 0,name_device: @device.name,notification:2,info:{
														...
														images: @traveller[:images] ? "http://"+request.host_with_port+"/assets/images_travellers/"+@traveller.images : "http://"+request.host_with_port+"/assets/images_travellers/no_image.png" ,
														lat:@device.lat == nil ? "" : @device.lat,
														lng:@device.lng == nil ? "" : @device.lng,
								...
								render json:{ 
												status:0,message: "Success",details:{
													group: 0,name_device: @device.name,notification:2,info:{
														...
														address:@traveller[:address],
														tour_name:@traveller.tours.first.name,
														images:@traveller[:images] ? "http://"+request.host_with_port+"/assets/images_travellers/"+@traveller.images : "http://"+request.host_with_port+"/assets/images_tourguide/no_image.png",
														lat:@device.lat == nil ? "" : @device.lat,
														lng:@device.lng == nil ? "" : @device.lng,
														phone:@traveller[:phone],
														device_id:@device.id
